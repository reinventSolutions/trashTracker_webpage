...
<div class="container" style="background-color:#b4b4b4; margin-top: 25px; margin-bottom: 25px">
  <div class="row">      
   <div class="col-sm" style="background-color:#FFFFFF; margin: 5px; padding: 15px 10px; height:auto;">
    ...
    <form name="userLogin" action="checklogin.php" metho="post">
      <div class="form-group">
        <label for="InputEmail1">Email address</label>
        <input type="email" class="form-control" id="userEmail1" aria-describedby="emailHelp" placeholder="Enter email">
      </div>
      <div class="form-group">
      ...
      <a class="btn btn-sm btn-success" role="button" href="index.html">Log In</a> <br>
    </form>

    <hr id="bottom_line">
    Or log in as<br> 
    <a class="btn btn-sm btn-primary" href="signup.html" role="button" onclick=""> New User</a> <br>  
