            ...
            $connection = mysqli_connect($DBservername, $DBusername, $DBpassword);
              ...
              $database = mysqli_select_db($connection, $DBname);  
                if (mysqli_connect_errno()) echo "Failed to connect to selected db" . mysqli_connect_error();
					  ...
					  //
					  if (isset($_POST['lowerValue2']) && isset($_POST['upperValue2'])){
							$lower = $_POST['lowerValue2'];
							$upper = $_POST['upperValue2'];
						}
					  ...
					  //$monthLow = $minRow[0] + floor($lower/4);//was 1, should add another 1 
					  $monthLow = ceil($lower/4);//was 1, should add another 1 
					  ...
					  $monthUp = ceil($monthUp2/4) + floor($upper/4); //ceil of this makes 18/4 = 5
					  $monthUp3 = $monthLow + 3;
