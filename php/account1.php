...
<!--
    ...
    2/1/2018
        ...
        <div class="container" style="background-color:#f7f7f7; margin-top:20px; padding:10px;">
            ...
            /*  php
              ...
              $result = mysqli_query($connection, "SELECT * FROM Bins"); 
            ...
            $connection = mysqli_connect($servername, $username, $password);
              ...
              if (mysqli_connect_errno()) echo "Failed to connect to MySQL: " . mysqli_connect_error();
                ...
                $list = mysql_query("SELECT Bin, Estimates FROM Bins");
                while($row = mysql_fetch_assoc($list)){
                  $data[] = "['".$row['Bin']."', ".$row['Estimate']."]";
                }
